...
export const SolverLab: React.FC<SolverLabProps> = ({
  ...
  return (
    <div className="flex flex-col gap-2.5 font-mono relative">
      {/* Toast Notification */}
      {toastMessage && (
      ...
      <div className="bg-slate-900/95 border border-cyan-500/50 rounded-lg p-3 backdrop-blur shadow-xl flex flex-col gap-2.5">
        <div className="flex items-center justify-between border-b border-slate-800 pb-2 gap-2 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="text-[11px] font-bold text-cyan-300 bg-cyan-950 hover:bg-cyan-900 px-2 py-1 rounded border border-cyan-800 flex items-center gap-1 min-h-[36px] transition"
            ...
            <button
              onClick={() => setIsInputsCollapsed((prev) => !prev)}
              ...
              title={isInputsCollapsed ? 'Expand Inputs' : 'Collapse Inputs'}
            >
              {isInputsCollapsed ? (
                <>
            ...
            {onClose && (
              <button
                ...
                title="Hide / Exit Solver Controls to focus on canvas"
              >
      ...
      {currentStep && (
        <div className="bg-slate-900/95 border border-emerald-500/40 rounded-lg p-3 backdrop-blur shadow-xl flex flex-col gap-2">
          <div className="flex items-center justify-between border-b border-slate-800 pb-1.5 gap-2 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => setIsTelemetryCollapsed((prev) => !prev)}
                className="p-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-slate-200 border border-slate-700 transition text-[10px] flex items-center gap-1 min-h-[30px]"
                title={isTelemetryCollapsed ? 'Expand Telemetry' : 'Collapse Telemetry'}
              >
